...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        ...
        <form action="{{route('applications.update', ['application' => $application->id])}}" method="post"
              class="m-form" enctype="multipart/form-data">
                    ...
                    <div class="tab-pane active show" id="tab_general" role="tabpanel">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-md-6">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input" name="date" type="date"
                                           value="{{$application->date}}" id="date" required
                            ...
                            <div class="col-10">
                                <select class="form-control m-select2" id="status" name="status" required>
                                    ...
                                    @foreach($statuses as $status)
                                        <option @if($application->status  == $status) selected
                            ...
                            <div class="col-10">
                                <select class="form-control m-select2" id="probability" name="probability" required>
                                    ...
                                    @foreach($probabilities as $propability)
                                        <option @if($application->probability  == $propability) selected
                                                @endif value="{{$propability}}">{{$propability}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-10">
                                <select class="form-control m-select2" id="active" name="active" required>
                                    ...
                                    @foreach($yesNo as $key => $choice)
                                        <option @if($application->active  == $key) selected
                                                @endif value="{{$key}}">{{$choice}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
